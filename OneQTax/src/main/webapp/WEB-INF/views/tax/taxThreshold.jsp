      ...
      <div class="container2">
        ...
        <div class="chart-box">
          ...
          <span style="color: #106e69;">
                            <p>달성금액 : <fmt:formatNumber value="${basicTotal}" groupingUsed="true"/>/<fmt:formatNumber value="${minimum_amount}" groupingUsed="true"/>원</p></span>
          <div class="chart1">
          ...
          <div class="info-box">
            ...
            <div class="info-item">신용카드 사용액 합계:&nbsp;<fmt:formatNumber value="${credit_total}" groupingUsed="true"/>원</div>
            <div class="info-item">체크카드 사용액 합계:&nbsp;<fmt:formatNumber value="${debit_total}" groupingUsed="true"/>원</div>
            <div class="info-item">현금영수증 사용액 합계:&nbsp;<fmt:formatNumber value="${cash_total}" groupingUsed="true"/>원</div>
            <div class="info-item">기타 공제항목 사용액 합계:&nbsp;<fmt:formatNumber value="${additionalTotal}" groupingUsed="true"/>원</div>
          </div>
          <br/>
